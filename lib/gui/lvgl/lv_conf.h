...
#define LV_DRAW_RELATIVE CONFIG_RATCH_LVGL_DRAW_RELATIVE
...
#ifdef CONFIG_RATCH_LVGL_MEM_POOL_THREAD

#define LV_MEM_CUSTOM_INCLUDE	"system/system.h"
#define LV_MEM_CUSTOM_ALLOC	system_malloc
#define LV_MEM_CUSTOM_FREE	system_free

#elif CONFIG_LVGL_MEM_POOL_HEAP_KERNEL
